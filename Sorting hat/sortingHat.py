...
image8 = ImageTk.PhotoImage(Image.open("8.png"))
image9 = ImageTk.PhotoImage(Image.open("9.png"))
image10 =ImageTk.PhotoImage(Image.open("10.png"))
imagewin = ImageTk.PhotoImage(Image.open("2.png"))

imagegriff = ImageTk.PhotoImage(Image.open("griff.png"))
imagesly = ImageTk.PhotoImage(Image.open("sly.png"))
imageraven = ImageTk.PhotoImage(Image.open("raven.png"))
imagehuff = ImageTk.PhotoImage(Image.open("huff.png"))
...
def q7(n):
  ...
  button_26 = Button(window, text= "a) Professor Sprout", padx= 40, pady=20,borderwidth=4,command= lambda :q8("s")) 
  button_27 = Button(window, text= "b) Professor Filius Fitwick", padx= 40, pady=20,borderwidth=4,command= lambda: q8("f")) 
  button_28 = Button(window, text= "c) Professor McGonagall", padx= 40, pady=20,borderwidth=4,command= lambda: q8("m")) 
  button_29 = Button(window, text= "d) Professor Quirrell", padx= 40, pady=20,borderwidth=4,command= lambda : q8("q")) 
